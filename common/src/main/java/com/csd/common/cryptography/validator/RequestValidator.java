...
public class RequestValidator {
    ...
    public RequestValidator(int q, int numberOfProxies) throws Exception {
        ...
        this.proxySignatureSuites = new ArrayList<>(numberOfProxies);

        IKeyRegistry pubKeyRegistry = new ExperimentalKeyRegistry();
